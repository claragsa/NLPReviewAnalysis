...
def get_sentiment(df, text_column='cleaned_text'):
    sentiment = []
    scores = []
...
def get_topics(df, text_column = 'cleaned_text', language = 'english', min_topic_size=50, n_gram_range=(1,2), n_top_words=10):
...
def common_words_by_sentiment(df, sentiment_column='sentiment', text_column = 'cleaned_text'):
